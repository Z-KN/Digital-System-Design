...
#
# Generated by Vivado on Wed Jun 05 21:25:17 +0800 2019
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_core xil_defaultlib.clk_core xil_defaultlib.glbl -log elaborate.log
}
